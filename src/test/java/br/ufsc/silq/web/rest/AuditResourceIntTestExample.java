...
import br.ufsc.silq.config.audit.AuditEventConverter;
import br.ufsc.silq.domain.PersistentAuditEvent;
import br.ufsc.silq.repository.PersistenceAuditEventRepository;
import br.ufsc.silq.service.AuditEventService;
...
@IntegrationTest
@Transactional
public class AuditResourceIntTestExample {
