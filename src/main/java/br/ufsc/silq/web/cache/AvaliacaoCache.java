 ...
 * salvos em um {@link CurriculumCache} com um mesmo ID. Ao realizar a avaliação
 * é criada uma nova entrada em {@link AvaliacaoCache} com o mesmo ID do cache
 * dos currículos, contendo os resultados das avaliações.
 */
@Service
