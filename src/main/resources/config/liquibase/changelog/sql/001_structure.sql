...
--
-- TOC entry 2046 (class 0 OID 32888)
-- Dependencies: 175
...
--
-- TOC entry 1924 (class 2606 OID 33063)
...
--
-- TOC entry 1926 (class 2606 OID 33078)
-- Name: pk_evento; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY tb_evento
    ADD CONSTRAINT pk_evento PRIMARY KEY (co_seq_evento);


--
-- TOC entry 1928 (class 2606 OID 33084)
-- Name: pk_evento_usuario; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY rl_evento_usuario
    ADD CONSTRAINT pk_evento_usuario PRIMARY KEY (co_seq_evento_usuario);


--
-- TOC entry 1920 (class 2606 OID 33009)
-- Name: pk_periodico; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY tb_periodico
    ADD CONSTRAINT pk_periodico PRIMARY KEY (co_seq_periodico);


--
-- TOC entry 1922 (class 2606 OID 33015)
-- Name: pk_periodico_usuario; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY rl_periodico_usuario
    ADD CONSTRAINT pk_periodico_usuario PRIMARY KEY (co_seq_periodico_usuario);


--
-- TOC entry 1915 (class 2606 OID 16409)
-- Name: pk_qualis_cco; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY tb_qualis_cco
    ADD CONSTRAINT pk_qualis_cco PRIMARY KEY (co_seq_qualis_cco);


--
-- TOC entry 1912 (class 2606 OID 16401)
-- Name: pk_qualis_geral; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY tb_qualis_geral
    ADD CONSTRAINT pk_qualis_geral PRIMARY KEY (co_seq_qualis_geral);


--
-- TOC entry 1918 (class 2606 OID 32896)
...
--
-- TOC entry 1916 (class 1259 OID 33069)
...
--
-- TOC entry 1909 (class 1259 OID 41290)
-- Name: in_trgm_qualis_geral_avaliacao; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX in_trgm_qualis_geral_avaliacao ON tb_qualis_geral USING gin (no_area_avaliacao gin_trgm_ops);


--
-- TOC entry 1910 (class 1259 OID 41291)
-- Name: in_trgm_qualis_geral_titulo; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX in_trgm_qualis_geral_titulo ON tb_qualis_geral USING gin (no_titulo gin_trgm_ops);


--
-- TOC entry 1913 (class 1259 OID 41292)
-- Name: in_trn_qualis_cco_titulo; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX in_trn_qualis_cco_titulo ON tb_qualis_cco USING gin (no_titulo gin_trgm_ops);


--
-- TOC entry 1932 (class 2606 OID 33085)
-- Name: fk_evento_evento; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY rl_evento_usuario
    ADD CONSTRAINT fk_evento_evento FOREIGN KEY (co_evento) REFERENCES tb_evento(co_seq_evento);


--
-- TOC entry 1929 (class 2606 OID 33016)
-- Name: fk_periodico_periodico; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY rl_periodico_usuario
    ADD CONSTRAINT fk_periodico_periodico FOREIGN KEY (co_periodico) REFERENCES tb_periodico(co_seq_periodico);


--
-- TOC entry 1931 (class 2606 OID 33064)
...
--
-- TOC entry 1933 (class 2606 OID 33090)
-- Name: fk_usuario_evento; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY rl_evento_usuario
    ADD CONSTRAINT fk_usuario_evento FOREIGN KEY (co_usuario) REFERENCES tb_usuario(co_seq_usuario);


--
-- TOC entry 1930 (class 2606 OID 33021)
-- Name: fk_usuario_periodico; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY rl_periodico_usuario
    ADD CONSTRAINT fk_usuario_periodico FOREIGN KEY (co_usuario) REFERENCES tb_usuario(co_seq_usuario);
...
-- Completed on 2014-10-08 21:58:57
